    ...
    public void onDrawerItemClick(int actionId)
    {
        switch (actionId)
        {
            ...
            case RlDrawer.DRAWER_ACTION_INVITE:
            {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "Hello, "+AppPreferences.GetName()+" Invited you to try the IBS 2k17 App.Click here to download the App: https://play.google.com/store/apps/details?id=com.brandslam.threeisummit");
